       ...
       <Popover.Trigger className={clsx('w-10 h-10 border-2 rounded-lg', {
        ...
        <Popover.Portal>
          <Popover.Content className="min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col">
            <span className="font-semibold text-zinc-400">Terça-feria</span>
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              >
                <div className="h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-500en">
                  <Checkbox.Indicator>
