...
CREATE TABLE "new_habi_week_days" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "habit_id" TEXT NOT NULL,
    "week_day" INTEGER NOT NULL,
    CONSTRAINT "habi_week_days_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_habi_week_days" ("habit_id", "id", "week_day") SELECT "habit_id", "id", "week_day" FROM "habi_week_days";
DROP TABLE "habi_week_days";
ALTER TABLE "new_habi_week_days" RENAME TO "habi_week_days";
CREATE UNIQUE INDEX "habi_week_days_habit_id_week_day_key" ON "habi_week_days"("habit_id", "week_day");
